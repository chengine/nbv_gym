...
def resize_images(images: List[Image.Image], scale_factor: Optional[float] = None) -> List[Image.Image]:
    """
...
def main():
    ...
    parser.add_argument("-d", "--duration", type=int, default=500, help="Duration per frame in milliseconds")
    parser.add_argument("-l", "--loop", type=int, default=0, help="Number of loops (0 for infinite)")
    parser.add_argument("-s", "--scale", type=float, metavar="FACTOR", 
