...
from shadow_splat.viewer import ShadowSplatViewer, LumenViewer

class LumenTrainer(Trainer):
    """Custom trainer that uses the Lumen custom viewer."""
...
@dataclass
class LumenTrainerConfig(TrainerConfig):
    """Configuration for Lumen training regimen"""

    _target: Type = field(default_factory=lambda: LumenTrainer)
