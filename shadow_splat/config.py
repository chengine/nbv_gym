...
from shadow_splat.trainer import ShadowSplatTrainerConfig, ShadowSplatTrainer, LumenTrainerConfig, LumenTrainer

from shadow_splat.model import LumenModelConfig

lumen = MethodSpecification(
    LumenTrainerConfig(
    method_name="lumen",
