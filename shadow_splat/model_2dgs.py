...
class ShadowSplat2DGSModel(Splatfacto2DGSModel):
    ...
    def get_outputs(
        ...
        if irradiance is not None:
            ...
            assert not torch.isnan(relit_rgb).any(), "Relit rgb is nan"
            assert not torch.isinf(relit_rgb).any(), "Relit rgb is inf"
        else:
        ...
        return {
            ...
            "distort": render_distort.squeeze(0),  # type: ignore
            "median": render_median.squeeze(0),  # type: ignore
        }  # type: ignore